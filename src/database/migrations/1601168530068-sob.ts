...
export class sob1601168530068 implements MigrationInterface {
    name = 'sob1601168530068'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `trip` (`idTrip` varchar(36) NOT NULL, `duration` time NOT NULL, `departure_date` date NOT NULL, `departure_time` time NULL, `arrival_date` date NULL, `arrival_time` time NOT NULL, `status` varchar(255) NOT NULL DEFAULT 'ON_HOLD', `min_price` double NULL, `max_price` double NULL, `price_online` double NOT NULL, `codigo_trip` varchar(255) NOT NULL, `carril` varchar(255) NOT NULL, `mode` varchar(255) NOT NULL, `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `originIdRoute` varchar(36) NULL, `destinationIdRoute` varchar(36) NULL, `busIdBus` varchar(36) NULL, PRIMARY KEY (`idTrip`)) ENGINE=InnoDB", undefined);
